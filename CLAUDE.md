...
**Testing:** 132 Vitest tests (pure logic). Every migration verified on Postgres 16, idempotent. Migrations are also mirrored as one-file `supabase/phase*.sql` for the owner to paste-run.
