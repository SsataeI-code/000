...
**Testing:** 177 Vitest tests (pure logic). Every migration verified on Postgres 16, idempotent (0008/0009/0010 RLS isolation checked end-to-end; 0011 structure verified). Migrations are also mirrored as one-file `supabase/phase*.sql` for the owner to paste-run.
