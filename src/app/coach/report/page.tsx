...
export default async function CoachReportPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <section aria-label="Wins to celebrate" className="flex flex-col gap-3 border border-hairline bg-surface p-5">
      ...
      <section aria-label="Who needs you" className="flex flex-col gap-3 border border-hairline bg-surface p-5">
