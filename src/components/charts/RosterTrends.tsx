    ...
    <section className="flex flex-col gap-5 rounded-lg border border-hairline bg-surface p-5">
      <div className="flex items-baseline justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          <p className="hidden font-body text-sm text-ink/50 sm:block">last {days}d · {series.clientCount} clients</p>
          {toggle}
        </div>
      </div>
      ...
      <div className="rounded-lg border border-hairline bg-surface-muted p-4">
        <p className="font-label text-sm uppercase tracking-wide text-ink/50">Weight direction</p>
        {ws.tracked === 0 ? (
          ...
          <>
            ...
            <div className="mt-2 flex flex-wrap gap-x-4 gap-y-1 font-body text-sm text-ink/70">
      ...
      <div>
        <p className="mb-2 font-label text-sm uppercase tracking-wide text-ink/50">Clients logging food / day</p>
      ...
      <div>
        <p className="mb-2 font-label text-sm uppercase tracking-wide text-ink/50">Habit engagement / day</p>
