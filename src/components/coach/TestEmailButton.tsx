...
/** Owner/coach: fire a sample re-engagement email to yourself to verify Resend. */
    ...
    <section className="border border-hairline bg-surface p-5">
      <div className="flex items-center justify-between gap-3">
        <div>
          ...
          <p className="mt-1 font-body text-sm text-ink/70">Send yourself a test re-engagement email.</p>
        </div>
        <button
          type="button"
          disabled={pending}
          onClick={() => start(async () => setResult(await sendTestEmailAction()))}
