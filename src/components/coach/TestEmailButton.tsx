      ...
      <div className="mt-3 flex items-end gap-2">
        <div className="flex-1">
          ...
          <input
            ...
            className="min-h-tap w-full rounded-2xl border border-hairline bg-surface shadow-card px-3 py-2 font-body text-sm text-ink placeholder:text-ink/40 focus:border-ink"
          />
        </div>
        <button
          type="button"
